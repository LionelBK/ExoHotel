...
public class HotelModel {
     ...
     */
    private static String[] villes = { "Paris", "Londres", "New York" };//ajout
    ...
    private static Hotel[] hotels = {
            ...
            new Hotel("Hotel English", "English Hotel", "London", 1),//ajout
            new Hotel("Hotel US", "US Hotel", "New York", 4)};//ajout
